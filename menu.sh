...
echo -e "* cek       : cek member login OpenVPN"
echo -e "* resvis    : restart service dropbear"
echo -e "              squid3, OpenVPN dan SSH"
echo -e "* reboot    : reboot VPS"
echo -e "* speedtest : speedtest VPS"
echo -e "* info -e   : menampilkan informasi sistem"
echo -e "* about     : info script auto install"
echo -e "* exit      : keluar dari Putty/JuiceSSH"
echo -e ""